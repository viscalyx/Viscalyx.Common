...
ConvertFrom-StringData @'
    ...
    Resolve_DnsName_NoIPv4Found = No IPv4 addresses found for '{0}'. (RDN0003)
    ...
    Send_WakeOnLan_InvalidMacAddress = Invalid MAC address format '{0}'. Expected format: 'XX:XX:XX:XX:XX:XX' or 'XX-XX-XX-XX-XX-XX'. (SWOL0003)
